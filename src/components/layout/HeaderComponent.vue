...
<template>
  <header class="header">
    ...
    <div class="header__actions">
      <div v-if="logged" class="header__actions--button mr-1">
        <button class="btn btn__md">+ New recipe</button>
      </div>
      <div v-if="logged" class="header__actions--avatar">GM</div>
      <div v-if="!logged" class="header__actions--button mr-1">
        <button class="btn btn__md">Sign in</button>
      </div>
    </div>
  </header>
</template>